...
Species: Taï Forest ebolavirus (TAFV)
NCBI Taxonomy ID: txid186541
Reference Assembly: NC_014372.1 (FJ217162.1)
Expected Complete Protein Dataset: 36 sequences
===============================================================================
Description:
    This script automates the retrieval of full-length protein sequences for all
    seven structural and non-structural proteins of Taï Forest ebolavirus
...
protein_tasks = {
    "1. Nucleoprotein": (
        'txid186541[Organism] AND ("Nucleoprotein"[Protein Name] OR "NP"[Protein Name] OR '
    ...
    "2. Polymerase cofactor VP35": (
        'txid186541[Organism] AND ("VP35"[Protein Name] OR "polymerase cofactor"[Protein Name] OR '
    ...
    "3. Matrix protein VP40": (
        'txid186541[Organism] AND ("VP40"[Protein Name] OR "matrix protein"[Protein Name]) '
        'NOT (partial[Title] OR fragment[Title] OR chain[Title] OR mutant[Title] OR '
        'synthetic[Title] OR construct[Title]) AND (290:360[SLEN])'
    ),

    "4. Glycoprotein GP": (
        'txid186541[Organism] AND ("glycoprotein"[Title] OR "GP"[Title] OR "spike protein"[Title] OR '
    ...
    "5. Minor nucleoprotein VP30": (
        'txid186541[Organism] AND ("VP30"[Protein Name] OR "transcription factor"[Protein Name] OR '
    ...
    "6. Membrane-associated protein VP24": (
        'txid186541[Organism] AND ("VP24"[Protein Name] OR "minor matrix protein"[Protein Name] OR '
    ...
    "7. RNA polymerase L": (
        'txid186541[Organism] AND ("polymerase"[Title] OR "L protein"[Title] OR "large protein"[Title] OR '
...
def run_downloader():
    ...
    print(f"Target Species: Taï Forest ebolavirus (TAFV, txid186541)")
    print("=" * 70)
    ...
    print(f"Species: Taï Forest ebolavirus (TAFV)")
    print("=" * 70)
    
    with open(report_file, "w", encoding="utf-8") as rep:
        rep.write("=" * 60 + "\n")
        rep.write(f"NCBI ENTREZ PROTEIN DOWNLOAD REPORT: Taï Forest ebolavirus (TAFV)\n")
        rep.write(f"Taxonomy ID: txid186541\n")
        rep.write("=" * 60 + "\n\n")
    ...
    print(f"Total sequences retrieved: {total_downloaded} (Expected: 36)")
